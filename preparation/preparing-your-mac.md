...
Within a year, your machine will start to accumulate a lot of dust. When this happens, your fans work harder to dissipate heat. When your CPU gets too hot, your machine throttles CPU performance. (If you see `kernel_task` eating up 80–90% of your processes, it’s definitely happening.)

![You can see kernel\_task running at 2.8%.](<../.gitbook/assets/image (5).png>)

You can have it cleaned at your local iStore, which probably costs around PHP 800 (about $16), or you can do it yourself if you have the right tools.<br>
